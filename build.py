...
<div class="reveal">
  <a class="btn disabled" href="#" aria-disabled="true">{download} {dl_icon}</a>
  <div class="cv-placeholder">{placeholder}</div>
</div>
...
""".format(eyebrow=t["cv_eyebrow"], title=t["cv_title"], desc=t["cv_desc"], download=t["download"], dl_icon=icon("download"),
           placeholder=t["cv_placeholder"], core_skills=t["core_skills"], skills_tags=tags_html(CV["core_skills"]),
